...
urlpatterns = [
    ...
    path('products/new', ServiceCreateView.as_view()),
    ...
    path('products/<int:pk>/edit', ServiceUpdateView.as_view()),
    path('products/<int:pk>/delete/', ServiceDeleteView.as_view(), name='service_delete'),
    path('products/<int:pk>/delete', ServiceDeleteView.as_view()),
    ...
    path('ads/new', AdvertisingCampaignCreateView.as_view()),
    path('ads/statistic/', CampaignStatsView.as_view(), name='campaign_stats'),
    path('ads/statistic', CampaignStatsView.as_view()),
    ...
    path('ads/<int:pk>/edit', AdvertisingCampaignUpdateView.as_view()),
    path('ads/<int:pk>/delete/', AdvertisingCampaignDeleteView.as_view(), name='campaign_delete'),
    path('ads/<int:pk>/delete', AdvertisingCampaignDeleteView.as_view()),
    ...
    path('leads/<int:lead_pk>/convert', CustomerCreateView.as_view()),
